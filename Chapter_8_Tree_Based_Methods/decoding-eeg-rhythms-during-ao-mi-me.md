...
class EEG:
    ...
    ****** If you want to edit, see ICA_plot and preprocessing function ********
    ...
    def split_count(self, count, raw_array):
        ...
        count : count number
        Note 
        scenario 1 and 2 have 1 count (trial) 
...
```
    ...
    ## [1] "/Volumes/T7/Github/An-Introduction-To-Statistical-Learning-With-Applications-In-R-Second-Edition/Chapter_8_Tree_Based_Methods"
